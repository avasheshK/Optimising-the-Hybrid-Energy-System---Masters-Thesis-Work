...
def check_constraints(intraday_vars, grid_buy_vars, battery_charge_vars, battery_discharge_vars, battery_SOC_vars, battery_action):
...
def revenue_generated():
    ...
    problem += (
        pl.lpSum([intraday_vars[t-1][t] * intraday_prices[t] for t in time_frame]) - pl.lpSum([grid_buy_vars[t] * intraday_prices[t]] for t in range(data_points))
    ) 
    ...
    check_constraints(intraday_vars, grid_buy_vars, battery_charge_vars, battery_discharge_vars, battery_SOC_vars, battery_action)
